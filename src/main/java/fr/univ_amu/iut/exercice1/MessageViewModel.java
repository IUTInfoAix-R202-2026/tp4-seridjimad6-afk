 ...
 *
 * <p>
 * Le ViewModel est le cœur du pattern MVVM. Il expose l'état de l'interface
 * sous forme de
 * <b>propriétés observables</b> ({@link StringProperty}, etc.) et fait le pont
 * avec le {@link
 * Message modèle}. Point capital : il n'importe AUCUN composant JavaFX
 * d'interface (pas de {@code
 * Label}, pas de {@code TextField}). Il est donc testable avec un simple test
 * JUnit, sans lancer
 ...
 *
 * <ul>
 * <li>expose {@code texte} (lecture/écriture) que la vue liera à un champ de
 * saisie ;
 * <li>maintient le modèle synchronisé : toute modification de la propriété est
 * répercutée dans le
 * {@link Message} ;
 * <li>expose {@code apercu} (lecture seule), une propriété DÉRIVÉE qui se
...
public class MessageViewModel {
  ...
  public MessageViewModel(Message message) {
    ...
    texte.addListener((observable, ancienneValeur, nouvelleValeur) -> message.setTexte(nouvelleValeur));
