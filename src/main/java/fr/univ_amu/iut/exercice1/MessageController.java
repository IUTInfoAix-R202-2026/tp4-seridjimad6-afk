 ...
 *
 * <p>
 * En MVVM, le contrôleur de vue est très <b>mince</b> : il ne contient aucune
 * logique métier ni
 * d'affichage. Son unique rôle est de <b>câbler</b> les composants de la vue
 * (FXML) aux propriétés
 * du {@link MessageViewModel}. On dit qu'il "branche les fils".
 *
 * <p>
 * Le ViewModel est fourni par le constructeur. Pour l'instant (exercice 1),
 * c'est la classe
 * {@link MessageApp} qui construit le ViewModel et le passe à la main via
 * {@code
